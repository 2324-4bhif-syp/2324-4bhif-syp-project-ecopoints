...
|Abdulla Aldesoky
| image:img/Abdullah-Aldesoky.jpg[width=100, height=100]
...
1. Navigate to the folder with the ssh-key-xxxx-xx-xx.key File

2. Connect to the server - (Public IP address: 138.2.138.31)

 sudo ssh -i './ssh-key-xxxx-xx-xx.key' ubuntu@138.2.138.31

3. In windows we don't use the sudo command

 ssh -i '.\ssh-key-xxxx-xx-xx.key' ubuntu@138.2.138.31