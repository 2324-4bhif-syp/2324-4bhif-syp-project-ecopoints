...
[.font-xx-large, background-image="traffic.jpg", background-opacity="0.5"]
== Sprint 4

=== Vorbereitung für den Tag der offenen Tür (Video)

image::traffic.jpg[background, size=cover, background-opacity="0.5"]


[background-image="traffic.jpg", background-opacity="0.5"]
=== Test
