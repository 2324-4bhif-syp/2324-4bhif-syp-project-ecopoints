...
public class ApplicationDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Graph>().HasData(
            ...
            new Graph { Id = 9, Title = "GpsVsObd", IFrameLink = "http://localhost:3000/d-solo/ee2r6d08shr7ka/eco-points?orgId=1&from=now&to=now-30&var-ids=$ids&panelId=9&theme=light&css=.panel-container,.graph-panel{background-color:white !important;}.flot-background{fill:white !important;}", RequiresCalc = true }
