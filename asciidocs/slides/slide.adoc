...
[background-image="google-maps.jpg", background-opacity="0.3"]
=== Oliver
...
[background-image="sprint7/ranking.jpg", background-opacity="0.3"]
=== Armin
...
[background-image="sprint7/profileNew.jpg", background-opacity="0.3"]
=== Laurent
