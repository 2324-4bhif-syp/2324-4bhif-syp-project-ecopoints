...
|Oliver Daxinger
| image:team/Daxinger-Oliver.jpg[width=50, height=150]



|Laurent Mali
| image:team/Laurent-Mali.jpg[width=50, height=150]

|Linus Nestler
| image:team/Linus-Nestler.jpeg[width=50, height=150]

|Armin Salkovic
|image:team/Armin-Salkovic.jpeg[width=50, height=150]
